...
OUTPUT_DIR="${SCRIPT_HOME}/../src/c/CAmkES/slang_libraries/source_thread_impl_source_process_component_source_thread_component"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/t/test_data_port_periodic_domains${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/t/source_thread_impl_source_process_component_source_thread_component" \
  --output-dir "${OUTPUT_DIR}" \
  --name "source_thread_impl_source_process_component_source_thread_component" \
  --apps "t.source_thread_impl_source_process_component_source_thread_component.source_thread_component" \
  --fingerprint 3 \
  --bits 32 \
  --string-size 256 \
  --sequence-size 2 \
  ...
  --forward "art.ArtNative=t.source_thread_impl_source_process_component_source_thread_component.source_thread_component" \
  --stack-size "61440" \
  --stable-type-id \
  ...
  --exclude-build "t.test_data_port_periodic_domains.source_thread_impl_source_process_component_source_thread_component" \
  --lib-only \
  --verbose
...
${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/t/SlangTypeLibrary" \
  --output-dir "${OUTPUT_DIR}" \
